    ...
    def handle_substitutions(self, raw_actions):
        ...
        for team in [1, 0]:
            if sub_count[team][IN_SUB_STRING] != sub_count[team][OUT_SUB_STRING]:
                print(team)
                error = f'{self.current_game["game_id"]}, {team}, IN: {sub_count[team][IN_SUB_STRING]}, OUT: {sub_count[team][OUT_SUB_STRING]}'
        ...
        for season in seasons:
            ...
            for game in tqdm(games):
                ...
                if not raw_actions:
                    ...
                    continue
                elif game['game_id'] in {'24095','24114'}:
